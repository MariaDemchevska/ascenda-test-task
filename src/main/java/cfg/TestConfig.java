...
public interface TestConfig extends Config {
    ...
    @Key("CLIENT_ID") //assuming we are passing these credentials during test execution from Jenkins Credentials
    String clientId();

    @Key("CLIENT_SECRET") //assuming we are passing these credentials during test execution from Jenkins Credentials
    String clientSecret();
